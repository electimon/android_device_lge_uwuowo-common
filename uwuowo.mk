...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/wifi/$(TARGET_BOARD_PLATFORM)/WCNSS_cfg.dat:system/etc/firmware/wlan/prima/WCNSS_cfg.dat \
    $(LOCAL_PATH)/wifi/$(TARGET_BOARD_PLATFORM)/WCNSS_qcom_cfg.ini:system/etc/firmware/wlan/prima/WCNSS_qcom_cfg.ini \
    $(LOCAL_PATH)/wifi/$(TARGET_BOARD_PLATFORM)/WCNSS_qcom_wlan_nv.bin:system/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv.bin \
    $(LOCAL_PATH)/wifi/$(TARGET_BOARD_PLATFORM)/WCNSS_qcom_wlan_nv.bin:system/etc/firmware/wlan/prima/WCNSS_qcom_wlan_nv_boot.bin \
    $(LOCAL_PATH)/wifi/$(TARGET_BOARD_PLATFORM)/WCNSS_qcom_cfg.ini:system/etc/wifi/WCNSS_qcom_cfg.ini \
